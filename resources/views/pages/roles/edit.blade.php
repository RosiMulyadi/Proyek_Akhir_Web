                    ...
                    <div class="form-group">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-check">
                                        <input class="form-check-input" value="{{ $value->id }}" name="permission[]" type="checkbox" id="permission_{{ $value->id }}" @if(in_array($value->id, old('permission', $rolePermissions))) checked @endif>
